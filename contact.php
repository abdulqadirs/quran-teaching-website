...
<html>
  ...
  <body>
          ...
          <ul style="color:white">
            ...
            <li>
              <a href="#contact" style="color:white;">
                <span class="fa fa-angle-double-down fa-3x pl-5 ml-5" onclick="scrollwin()"></span>
              </a>
            </li>
          </ul>
        </div>
    ...
    <br>
    <!-- contact form -->
    <div class="container bg-faded" id="contact">
      <div class="row justify-content-center text-white" style="background-color:rgba(66, 4, 236, 0.92);">
        <h4>Contact Form</h4>
      </div>
        ...
        <div class="col-sm-8">
          <form>
            <div class="form-group">
              ...
              <input type="email" class="form-control"  placeholder="&#xf007;     Enter name" style="font-family:Arial, FontAwesome" required>
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Email</label>
              <input type="email" class="form-control" placeholder="&#xf0e0;    Enter email" style="font-family:Arial, FontAwesome" required>
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Phone</label>
              <input type="tel" class="form-control"  placeholder="&#xf095;      Enter phone" style="font-family:Arial, FontAwesome" required>
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Country&City</label>
              <input type="text" class="form-control"  placeholder="&#xf0ac;     Enter country&city" style="font-family:Arial, FontAwesome" required>
            </div>
            <div class="form-group">
    ...
    <div class="container">
      <div class="row justify-content-center text-white" style="background-color: rgba(66, 4, 236, 0.92)">
        <h4><span class="fa fa-phone fa-lg"></span> USA: +1-786-837-7505</h4>
      </div>
    </div>
    ...
    <!-- footer -->
    <div class="container-fluid  border border-default border-bottom-0 border-right-0 border-left-0 footer">
      <div class="row">
