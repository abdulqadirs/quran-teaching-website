      ...
      <div class="container h-100">
        <div class="row h-100 justify-content-center align-items-center">
          <ul style="color:white">
            ...
            <li>
              <a href="#faqs">
                <span class="fa fa-angle-double-down fa-3x pl-4 ml-2"></span>
              </a>
            </li>
          </ul>
        </div>
    ...
    <div class="container" id="faqs">
      <div class="row">
        <div class="col-12 col-md-6">
          <p class="fa fa-lock question">
            <b>Do I need Credit card information for Trial classes?</b>
            <hr>
          </p>
          <p class="answer">No, you are not required to give credit card information for trial lessons.</p>
        </div>
        <div class="col-12 col-md-6">
          <p class="fa fa-lock question">
          ...
          <p class="answer">We accept PayPal, Secure online credit card and wire Transfer.</p>
        </div>
        <div class="col-12 col-md-6">
          <p class="fa fa-lock question">
            <b>Is there any offline payment method?</b>
            <hr>
          </p>
          <p class="answer">Yes, you can make payment with Bank transfer, Check, Money Order and Western Union.</p>
        </div>
        <div class="col-12 col-md-6">
          <p class="fa fa-lock question">
            <b>Do I have to give credit card information to any one?</b>
            <hr>
          </p>
          <p class="answer">No. You are not required to give credit card information to anyone. You will make payment online in very secure
            environment.
          </p>
        </div>
        <div class="col-12 col-md-6">
          <p class="fa fa-lock question">
            <b>Is there any discount for family members?</b>
            <hr>
          </p>
          <p class="answer">Yes, there is discount for two or more than two members of the family.</p>
        </div>
        <div class="col-12 col-md-6">
          <p class="fa fa-lock question">
            <b>What if I want to cancel my classes?</b>
            <hr>
          </p>
          <p class="answer">You may cancel your subscription any time by giving 1 months notice.</p>
        </div>
      </div>
    </div>
    <br>
